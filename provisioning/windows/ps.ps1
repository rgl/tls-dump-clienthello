...
# NB this exists in Windows Server 2022 and Windows 11.
if ([Enum]::GetValues([Net.SecurityProtocolType]) -contains 'Tls13') {
    [Net.ServicePointManager]::SecurityProtocol = [Net.ServicePointManager]::SecurityProtocol `
...
Set-Location c:/vagrant/provisioning/windows
